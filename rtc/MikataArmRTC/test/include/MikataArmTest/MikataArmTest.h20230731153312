...
#ifndef MIKATAARM_TEST__H
#define MIKATAARM_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  MikataArmTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~MikataArmTest() override;
 ...
 protected:
  ...
  /*!
   */
  RTC::InPort<RTC::TimedFloatSeq> m_JointStatesIn;
...
extern "C"
{
  DLL_EXPORT void MikataArmTestInit(RTC::Manager* manager);
};

#endif // MIKATAARM_TEST_H
