...
/*!
 * @file  ManipulatorControlSample2.h
 * @brief ModuleDescription
 *
 */
// </rtc-template>

#ifndef MANIPULATORCONTROLSAMPLE2_H
#define MANIPULATORCONTROLSAMPLE2_H
...
/*!
 * @class ManipulatorControlSample2
 * @brief ModuleDescription
 *
 */
// </rtc-template>
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ManipulatorControlSample2(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~ManipulatorControlSample2() override;
...
extern "C"
{
  DLL_EXPORT void ManipulatorControlSample2Init(RTC::Manager* manager);
};

#endif // MANIPULATORCONTROLSAMPLE2_H
